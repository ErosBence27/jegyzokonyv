...
- **Antenna telepítése a laborban:**
  ![Antenna](image/antenna_telepites.png)

- **Johansson 6700 csatlakoztatása és beállítása:**
  ![Johansson 6700](image/Johansson_beallitas.png)

- **Jelerősség diagram:**
  ![Jelerősség diagram](image/jeleroesseg_diagram.png)
